...
function ProductCategories({ products }) {
  ...
  return (
    <section className="bg-[#F4F8F1] py-24">
      <div className="max-w-7xl mx-auto px-6">

        <div className="text-center mb-14">
          <p className="uppercase tracking-widest text-[#CD9707] font-semibold">
            Explore Our Range
          </p>
          ...
          {categories.map(([category, count]) => {
            ...
            return (
              <Link
                ...
                className="bg-white rounded-2xl p-8 text-center hover:-translate-y-2 hover:shadow-xl transition"
              >
                <div
                ...
                <h3 className="font-dm text-2xl">{category}</h3>
